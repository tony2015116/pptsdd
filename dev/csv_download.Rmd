...
#' @description
#' 
#' This function logs into a given URL with a username and password, and downloads a CSV file.
#'
...
#'
#' @return This function has no return value. It downloads a CSV file and saves it to the specified path.
#' 
#' @export
